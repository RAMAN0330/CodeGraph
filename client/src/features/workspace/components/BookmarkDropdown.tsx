  ...
  return (
    <DropdownMenu open={open} onOpenChange={setOpen}>
      ...
      <DropdownMenuContent
        align="end"
        sideOffset={6}
        className="p-0 rounded-none border-0 bg-transparent shadow-none"
        style={{
          width: '320px',
          ...
          return (
            ...
            >
              ...
              <Button
                ...
                style={{ background: 'none', color: item.pinned ? '#a67c00' : 'var(--text-muted)', fontSize: 14, padding: '2px 4px', flexShrink: 0 }}
              >
                {item.pinned ? '★' : '☆'}
              </Button>
              <Button
                ...
                title="Remove"
                style={{ background: 'none', color: 'var(--text-muted)', fontSize: 16, padding: '2px 4px', flexShrink: 0 }}
              >
                ×
              </Button>
            </div>
