...
export default function LandingPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0d1117', color: '#f0f6fc', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' }}>
      {/* Nav */}
      <nav style={{ padding: '10px 16px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'sticky', top: '10px', zIndex: 100 }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%', background: 'rgba(22,27,34,0.92)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)', border: '1px solid #30363d', borderRadius: '12px', padding: '0 16px', height: '46px', boxShadow: '0 4px 24px rgba(0,0,0,0.4)' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <button onClick={handleAuth} style={{ background: '#238636', border: '1px solid #2ea043', color: 'white', padding: '5px 14px', borderRadius: '6px', fontSize: '0.85rem', fontWeight: 600, cursor: 'pointer' }}>
            Sign in with GitHub
          </button>
        </div>
        </div>
      ...
      {/* Hero */}
      <section style={{ maxWidth: '960px', margin: '0 auto', padding: '72px 24px 80px', textAlign: 'center' }}>
