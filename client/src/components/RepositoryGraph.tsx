...
const initialNodes = [
  { id: 'root', type: 'input', data: { label: 'codeflow-repo' }, position: { x: 250, y: 5 }, style: { background: 'var(--bg-secondary)', color: 'white', border: '1px solid var(--accent-blue)', borderRadius: '8px' } },
